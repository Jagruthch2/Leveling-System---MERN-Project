...
const dungeonQuestSchema = new mongoose.Schema({
  name: {
    type: String,
  ...
  title: {
    type: String,
    required: [true, 'Completion title is required'],
    trim: true,
...
dungeonQuestSchema.index({ createdBy: 1, createdAt: -1 });

module.exports = mongoose.model('DungeonQuest', dungeonQuestSchema);
