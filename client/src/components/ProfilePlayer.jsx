...
const ProfilePlayer = () => {
  ...
  // Get rank color based on level (blue theme for player mode)
  const getRankColor = (level) => {
    if (level >= 100) return 'from-black via-blue-900 to-black';
    if (level >= 90) return 'from-blue-600 via-blue-500 to-blue-600';
    if (level >= 80) return 'from-blue-600 via-cyan-600 to-blue-600';
    if (level >= 70) return 'from-cyan-600 via-sky-600 to-cyan-600';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-blue-300 font-medium">Loading authentication...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-black flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-3/4 left-1/2 w-64 h-64 bg-sky-600/10 rounded-full blur-2xl"></div>
        {/* Subtle accent lines */}
      ...
      <div className="flex justify-between items-center p-6 relative z-10 bg-slate-900/30 backdrop-blur-sm border-b border-blue-500/30">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-cyan-700 rounded-lg flex items-center justify-center shadow-lg border-2 border-blue-500/50 backdrop-blur-sm">
        ...
        <button
          ...
          className="px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white rounded-lg transition-all duration-200 font-bold border border-red-500/50 shadow-lg hover:shadow-red-500/50 backdrop-blur-sm flex items-center space-x-2"
        >
      ...
      <div className="flex-1 p-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 relative">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-900/10 via-cyan-900/10 to-blue-900/10 rounded-2xl blur-2xl"></div>
            <div className="relative z-10 p-8">
              <div className="flex justify-center mb-6">
                <div className="w-20 h-20 bg-gradient-to-br from-blue-600 via-cyan-600 to-sky-600 rounded-full flex items-center justify-center shadow-2xl border-4 border-blue-500/30">
              ...
              <p className="text-blue-300 text-xl font-medium tracking-wide mb-6 max-w-2xl mx-auto">
                Track your journey through completed quests and earned achievements
              </p>
              ...
              <div className="mt-6 flex justify-center">
                <button
                  ...
                  disabled={loading}
                  className="px-8 py-3 bg-gradient-to-r from-blue-700 to-cyan-700 hover:from-blue-600 hover:to-cyan-600 text-white rounded-xl transition-all duration-300 font-semibold border border-blue-500/30 shadow-xl hover:shadow-blue-500/25 backdrop-blur-sm disabled:opacity-50 flex items-center space-x-2"
                >
          ...
          {loading ? (
            <div className="text-center py-16">
              ...
              <p className="text-blue-300 font-semibold text-xl">Loading hunter data...</p>
            </div>
          ) : error ? (
            <div className="text-center py-16">
              ...
              <button
                onClick={fetchProfileData}
                className="px-6 py-3 bg-blue-700 hover:bg-blue-600 text-white rounded-lg transition-all duration-200 font-semibold flex items-center space-x-2 mx-auto"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                </svg>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Main Profile Card */}
              <div className="bg-slate-900/70 backdrop-blur-xl rounded-2xl shadow-2xl border-2 border-blue-600/70 p-8 relative overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-10">
                  ...
                  <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-blue-600 via-cyan-500 to-sky-500"></div>
                  <div className="absolute top-0 right-0 w-1 h-full bg-gradient-to-b from-sky-500 via-cyan-500 to-blue-600"></div>
                </div>
                
                <div className="relative z-10">
                  <div className="flex items-center mb-8 pb-6 border-b border-blue-600/30">
                  ...
                  <div className="flex justify-center mb-8">
                    <div className={`w-28 h-28 bg-gradient-to-br ${rankColor} rounded-2xl flex items-center justify-center shadow-xl border-2 border-blue-500/30`}>
                  ...
                  <div className="text-center mb-8">
                    <h4 className="text-3xl font-bold text-blue-300 mb-2">
                      {profileData.name}
                    </h4>
                    <p className="text-blue-400 font-medium text-lg">Shadow Hunter Player</p>
                  </div>

                  {/* Level and Rank */}
                  <div className="mb-8">
                    <div className="bg-slate-800/50 rounded-xl p-6 border border-blue-600/30">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="text-right">
                          <div className="text-sm text-blue-400 mb-1">Total XP</div>
                      ...
                      {currentLevel < 100 && (
                        <div className="mt-4 pt-4 border-t border-blue-600/20">
                          <div className="flex justify-between items-center mb-2">
                            <span className="text-sm text-blue-300">Progress to Next Level</span>
                          ...
                          <div className="w-full bg-slate-700 rounded-lg h-3 overflow-hidden">
                            <div 
                              className="bg-gradient-to-r from-blue-500 via-cyan-500 to-sky-500 h-full transition-all duration-1000"
              ...
              <div className="space-y-8">
                ...
                <div className="bg-slate-900/70 backdrop-blur-xl rounded-2xl shadow-2xl border-2 border-blue-600/70 p-8 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center mb-6 pb-4 border-b border-blue-600/30">
                      ...
                      <div className="ml-auto text-sm text-blue-400 bg-blue-900/30 px-3 py-1 rounded-full">
                    ...
                    {profileData.titles.length > 0 ? (
                      <div className="space-y-3">
                        {profileData.titles.map((title, index) => (
                          <div 
                            key={index}
                            className="bg-slate-800/60 px-4 py-3 rounded-lg border border-blue-600/30 hover:border-cyan-500/50 transition-all duration-300 hover:bg-slate-800/80"
                          >
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                <span className="text-blue-300 font-semibold">
                                  {typeof title === 'string' ? title : title.name || title}
                                </span>
                                {typeof title === 'object' && title.source && (
                                  <div className="text-xs text-blue-400 mt-1">
                                    Source: {title.source.replace('_', ' ')}
                                    {title.awardedAt && (
                                      <span className="ml-2">• {new Date(title.awardedAt).toLocaleDateString()}</span>
                                    )}
                                  </div>
                                )}
                              </div>
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-blue-300 font-semibold">No achievements earned yet</p>
                        <p className="text-blue-400 text-sm">Complete quests to unlock titles and achievements!</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="bg-slate-900/70 backdrop-blur-xl rounded-2xl shadow-2xl border-2 border-blue-600/70 p-8 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center mb-6 pb-4 border-b border-blue-600/30">
                      <div className="w-4 h-4 bg-gradient-to-r from-cyan-500 to-sky-500 rounded-full mr-3"></div>
                      <h3 className="text-2xl font-bold text-blue-300">
                        Performance Metrics
                      </h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <div className="bg-slate-800/60 px-6 py-4 rounded-lg border border-blue-600/30">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="text-blue-300 font-semibold">Total Experience</span>
                          </div>
                      ...
                      <div className="bg-slate-800/60 px-6 py-4 rounded-lg border border-blue-600/30">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="text-blue-300 font-semibold">Current Level</span>
                          </div>
                      ...
                      <div className="bg-slate-800/60 px-6 py-4 rounded-lg border border-blue-600/30">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="text-blue-300 font-semibold">Earned Coins</span>
                          </div>
                      ...
                      <div className="bg-slate-800/60 px-6 py-4 rounded-lg border border-blue-600/30">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="text-blue-300 font-semibold">Titles Earned</span>
                          </div>
                      ...
                      {currentLevel >= 100 && (
                        <div className="bg-gradient-to-r from-blue-900/80 to-black/80 px-6 py-4 rounded-lg border border-blue-400/50">
                          <div className="text-center">
                            <div className="text-blue-300 font-bold text-lg mb-2">Max Level Achieved</div>
