...
const PenaltyQuests = () => {
  ...
  const fetchQuests = async () => {
    try {
      ...
      if (error.response?.status === 401) {
        ...
        showMessage('Failed to load penalty quests');
      }
    } finally {
      setLoading(false);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        showMessage('Penalty quest created successfully!', true);
        // Reset form
        setFormData({
          name: '',
          xp: '',
      ...
      if (error.response?.data?.message) {
        ...
        showMessage('Failed to create penalty quest');
      }
    } finally {
      setSubmitting(false);
    }
  ...
  const handleDeleteQuest = async (questId) => {
    if (!window.confirm('Are you sure you want to delete this penalty quest?')) {
      return;
    }
    ...
    try {
      ...
      if (response.data.success) {
        ...
        showMessage('Penalty quest deleted successfully!', true);
      }
    } catch (error) {
      ...
      if (error.response?.status === 401) {
        ...
        showMessage('Access denied. You can only delete your own penalty quests.');
      } else if (error.response?.data?.message) {
        showMessage(error.response.data.message);
      } else {
        showMessage('Failed to delete penalty quest');
      }
    } finally {
      setDeleting(null);
    }
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 relative">
            ...
            <div className="relative z-10 p-6">
              ...
              <p className="text-purple-300 text-lg font-medium">
                Overcome Challenges Through Disciplined Actions
              </p>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Enter penalty quest name..."
          ...
          <div className="bg-slate-900/70 backdrop-blur-xl rounded-xl shadow-xl border border-purple-600/50 p-6 relative overflow-hidden">
            ...
            <div className="flex items-center justify-center mb-6 relative z-10">
              ...
              <h3 className="text-2xl font-bold text-purple-300">
                Active Penalty Quests ({quests.length})
              </h3>
            </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-12 relative z-10">
                ...
                <p className="text-purple-300 text-xl font-semibold">No Penalty Quests Created Yet</p>
                <p className="text-purple-400 font-medium">Begin your journey by creating your first penalty quest above!</p>
              </div>
            ) : (
                    ...
                    <div className="pr-16">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center text-sm font-medium">
                          ...
                          <span className="text-purple-300">{quest.xp} XP Reward</span>
                        </div>
                        <div className="flex items-center text-sm font-medium">
