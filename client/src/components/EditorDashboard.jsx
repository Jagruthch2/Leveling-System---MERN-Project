...
const EditorDashboard = () => {
  ...
  const handleDungeonQuests = () => {
    navigate('/dungeon-quests');
  };

  const handlePenaltyQuests = () => {
    navigate('/penalty-quests');
  };
  ...
  // If Shop is active, render Shop component
  if (showShop) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-4 sm:p-6 gap-4">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-white">Editor Mode</h1>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 w-full sm:w-auto">
          <button
            ...
            className="px-3 sm:px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-200 font-medium flex items-center justify-center space-x-2 text-sm sm:text-base"
          >
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-400 mb-2 sm:mb-4">
            Editor Dashboard
          </h2>
          <p className="text-gray-300 text-base sm:text-lg md:text-xl max-w-md mx-auto px-2">
            Master your skills and conquer challenges
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {menuItems.map((item) => (
              <button
                ...
                className={`group relative h-28 sm:h-32 md:h-36 ${item.bgGradient} ${item.hoverBg} rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-500 animate-pulse hover:animate-none`}
              >
                {/* Border effect */}
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <p className="text-gray-400 text-xs sm:text-sm md:text-base px-4">
            Master your skills and conquer the digital realm
          </p>
        </div>
      </div>
